// Ваши ключи
const GEOCODER_KEY = '2234f14e-a26e-42e7-b494-e6f8c0f9bc3b'; // Геокодер (Key #2)
const ROUTING_KEY  = '26a5326e-3119-4c44-aea7-377da2892e04'; // Маршрутизация (Key #1)
...
async function getRoute(from, to, key) {
    ...
    if (data.error) {
        throw new Error(`API ошибка: ${data.error.message || 'Неизвестная ошибка'}`);
    }
